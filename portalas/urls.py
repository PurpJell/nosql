...
from .views import index_view, register_view, login_view, logout_view, profile_view, update_profile_view, skelbimai_view, skelbimu_kategorijos_view, update_kategorija_view, skelbimai_view, update_skelbimas_view, konkretus_skelbimas_view, skelbimo_busena_view
